return {
  ...
  ["junegunn/vim-easy-align"] = {
    opt = true,
    setup = function()
      table.insert(astronvim.file_plugins, "vim-easy-align")
    end,
  },
  ...
  ["TimUntersberger/neogit"] = {
    ...
    cmd = "Neogit",
    setup = function()
      table.insert(astronvim.git_plugins, "neogit")
    end,
    config = function()
  ...
  ["folke/todo-comments.nvim"] = {
    opt = true,
    setup = function()
      table.insert(astronvim.file_plugins, "todo-comments.nvim")
    end,
    requires = "nvim-lua/plenary.nvim",
    config = function()
  ...
  ["gpanders/editorconfig.nvim"] = {
    opt = true,
    setup = function()
      table.insert(astronvim.file_plugins, "editorconfig.nvim")
    end,
  },
  ...
  ["chrisgrieser/nvim-various-textobjs"] = {
    opt = true,
    setup = function()
      table.insert(astronvim.file_plugins, "nvim-various-textobjs")
    end,
    config = function()
      require("user.plugins.nvim-various-textobjs")
    end,
  },
