...
complete -c ex -s i --description 'Specifies the filename to use when reading or writing the viminfo file, inste…'
...
complete -c ex -s N --description 'No-compatible mode.   Resets the \'compatible\' option.'
