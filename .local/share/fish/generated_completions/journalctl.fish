...
complete -c journalctl -l facility --description 'Filter output by syslog facility.'
...
complete -c journalctl -l cursor-file --description 'If FILE exists and contains a cursor, start showing entries after this locati…'
...
complete -c journalctl -l namespace --description 'Takes a journal namespace identifier string as argument.'
...
complete -c journalctl -l vacuum-size -l vacuum-time -l vacuum-files --description 'Removes the oldest archived journal files until the disk space they use falls…'
...
complete -c journalctl -l flush --description 'Asks the journal daemon to flush any log data stored in /run/log/journal/ int…'
complete -c journalctl -l relinquish-var --description 'Asks the journal daemon for the reverse operation to --flush: if requested th…'
complete -c journalctl -l smart-relinquish-var --description 'Similar to --relinquish-var but executes no operation if the root file system…'
...
complete -c journalctl -l vacuum-file --description 'into a single command, see above.'
complete -c journalctl -o u/--unit --description 'should be used.'
