...
complete -c systemd-run -l unit -s u --description 'Use this unit name instead of an automatically generated one.'
...
complete -c systemd-run -l on-clock-change -l on-timezone-change --description 'Defines a trigger based on system clock jumps or timezone changes for startin…'
