...
complete -c git-pull -l recurse-submodules --description 'This option controls if new commits of populated submodules should be fetched…'
...
complete -c git-pull -s S -l gpg-sign -l no-gpg-sign --description 'GPG-sign the resulting merge commit.'
...
complete -c git-pull -l autostash -l no-autostash --description 'Automatically create a temporary stash entry before the operation begins, and…'
...
complete -c git-pull -l set-upstream --description 'If the remote is fetched successfully, pull and add upstream (tracking) refer…'
