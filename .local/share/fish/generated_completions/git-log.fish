...
complete -c git-log -l mailmap -l use-mailmap --description 'Use mailmap file to map author and committer names and email addresses to can…'
...
complete -c git-log -s p -s u --description '.'
...
complete -c git-log -l relative -l no-relative --description '.'
