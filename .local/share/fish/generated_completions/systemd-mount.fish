...
complete -c systemd-mount -s l -l full --description 'Do not ellipsize the output when --list is specified.'
complete -c systemd-mount -l no-pager --description 'Do not pipe output into a pager.'
complete -c systemd-mount -l no-legend --description 'Do not print the legend, i. e.  column headers and the footer with hints.'
...
complete -c systemd-mount -l bind-device --description 'This option only has an effect in automount mode, and controls whether the au…'
