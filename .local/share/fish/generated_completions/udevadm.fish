...
complete -c udevadm -s w -l wait-for-initialization --description 'Wait for device to be initialized.'
...
complete -c udevadm -l action --description 'Type of event to be triggered.'
...
complete -c udevadm -l settle --description 'Apart from triggering events, also waits for those events to finish.'
