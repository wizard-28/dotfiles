...
complete -c mount -l options-source-force --description 'non-root users mount always read fstab configuration.'
...
complete -c mount -s N -l namespace --description 'Perform mount in namespace specified by ns.'
...
complete -c mount -l options-mode --description 'Controls how to combine options from fstab/mtab with options from command lin…'
complete -c mount -l options-source --description 'Source of default options.'
