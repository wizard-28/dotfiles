...
complete -c git-am -s S -l gpg-sign -l no-gpg-sign --description 'GPG-sign commits.'
...
complete -c git-am -l show-current-patch --description 'Show the message at which git am has stopped due to conflicts.'
