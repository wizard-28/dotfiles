...
complete -c git-diff-tree -l no-color-moved --description 'Turn off move detection.  This can be used to override configuration settings.'
complete -c git-diff-tree -l no-color-moved-ws --description 'Do not ignore whitespace when performing move detection.'
...
complete -c git-diff-tree -l relative -l no-relative --description 'When run from a subdirectory of the project, it can be told to exclude change…'
...
complete -c git-diff-tree -o 'X[<param1' -l dirstat --description '.'
...
complete -c git-diff-tree -l unfold --description 'option was given.'
