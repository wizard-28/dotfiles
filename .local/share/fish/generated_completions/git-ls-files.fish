...
complete -c git-ls-files -l recurse-submodules --description 'Recursively calls ls-files on each active submodule in the repository.'
...
complete -c git-ls-files -s t --description '.'
