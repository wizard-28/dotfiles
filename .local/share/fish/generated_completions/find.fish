...
complete -c find -o quit --description 'Actions which inhibit the default.'
complete -c find -o exec --description '.'
complete -c find -o execdir --description '.'
complete -c find -o ok --description '.'
complete -c find -o okdir --description '.'
complete -c find -o fls --description '.'
complete -c find -o fprint --description '.'
complete -c find -o fprintf --description '.'
complete -c find -o ls --description '.'
complete -c find -o printf --description 'The.'
...
complete -c find -s d --description 'A synonym for -depth, for compatibility with FreeBSD, NetBSD,  MacOS X and Op…'
...
complete -c find -o links --description 'File has n hard links.'
...
complete -c find -o readable --description 'Matches files which are readable by the current user.'
complete -c find -o size --description 'File uses n units of space, rounding up.'
complete -c find -o 1M --description 'is not equivalent to.'
complete -c find -o 1048576c --description 'The former only matches empty files, the latter matches files from 0 to 1,048…'
...
complete -c find -o writable --description 'Matches files which are writable by the current user.'
